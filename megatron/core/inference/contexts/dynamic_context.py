...
from .mamba_slot_allocator import (
...
class DynamicInferenceContext(BaseInferenceContext):
    ...
    def __init__(self, model_config: TransformerConfig, inference_config: InferenceConfig):
        ...
        if self.is_hybrid_model:
            ...
            if (
                ...
                scratch_slots = compute_max_intermediate_count(
                    self.max_tokens, self.block_size_tokens
                )
    ...
    def _allocate_mamba_cache(self, mamba_gb: float) -> None:
        ...
        #                       (one boundary per block_size_tokens of max_tokens;
        #                       see compute_max_intermediate_count).
        ...
        scratch_slots = compute_max_intermediate_count(self.max_tokens, self.block_size_tokens)
