...
def test_disagg_engine_resolves_handoff_methods_from_mixin():
    ...
    assert (
        DisaggDynamicInferenceEngine.set_disaggregation_config
        is InferenceStateHandoffMixin.set_disaggregation_config
    )
    assert not hasattr(DynamicInferenceEngine, "set_disaggregation_config")
